...
public record TrimmedItemModel(Object2ObjectMap<ClientTrim, ItemModel> models) implements ItemModel {
    @Override
    public void update(ItemStackRenderState renderState, ItemStack stack, ItemModelResolver resolver, ItemDisplayContext context, @Nullable ClientLevel level, @Nullable LivingEntity holder, int i) {
    ...
    public record Unbaked(Object2ObjectMap<ClientTrim, ItemModel.Unbaked> cases, ResourceLocation itemName, ItemModel.Unbaked fallback) implements ItemModel.Unbaked {
        public static final MapCodec<Unbaked> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
            ResourceLocation.CODEC.fieldOf("item_name").forGetter(Unbaked::itemName),
        ...
        public ItemModel bake(ItemModel.BakingContext context) {
            ...
            this.cases.forEach((key, value) -> models.put(key, value.bake(context)));
