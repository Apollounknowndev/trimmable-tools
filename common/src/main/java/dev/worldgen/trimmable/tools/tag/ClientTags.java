...
public final class ClientTags {
    private static final Map<TagKey<?>, ClientTags.LoadedTag> LOCAL_TAG_HIERARCHY = new ConcurrentHashMap<>();
    ...
    public static ClientTags.LoadedTag getOrCreatePartiallySyncedTag(TagKey<?> tagKey) {
        ClientTags.LoadedTag loadedTag = LOCAL_TAG_HIERARCHY.get(tagKey);
    ...
    public static ClientTags.LoadedTag loadTag(TagKey<?> tagKey) {
        ...
        return new ClientTags.LoadedTag(Collections.unmodifiableSet(completeIds), Collections.unmodifiableSet(immediateChildTags),
